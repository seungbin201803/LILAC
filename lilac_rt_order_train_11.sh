#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_11 # give your job a name
#SBATCH --nodes=1
...
python3 ./run.py \
    ...
    --image_directory='/midtier/sablab/scratch/data/Prostate_RadiologyTreatment/image_crop_100' \
...
# 499245, 499253
# image_crop_100, image_size='100,100,100'
