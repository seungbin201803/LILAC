#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_25-2 # give your job a name
#SBATCH --nodes=1
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_21-3-temporal_ordering-backbone_cnn_3D-lr0.001-seed0-batch8/model_epoch9.pth' \
#     --lrscheduler 20 0.5 \
# #--inter_num_ch=16 \
# #--num_block=6
...
#     --csv_file_train='./RT_allpair_crop80-ants-sim__train.csv' \
#     --csv_file_val='./RT_allpair_crop80-ants-sim__val.csv' \
#     --csv_file_test='./RT_second_crop80-ants-sim_test.csv' \
#     --earlystopping=100 \
#     --lrscheduler 20 0.5 \
#     --run_mode='eval' \
# # 712038

# # test, firstfromsecondpat
# python3 ./run.py \
#     --jobname='lilac_rt_order_25-2' \
#     --task_option='o' \
#     --targetname='timepoint' \
...
#     --csv_file_train='./RT_allpair_crop80-ants-sim__train.csv' \
#     --csv_file_val='./RT_allpair_crop80-ants-sim__val.csv' \
#     --csv_file_test='./RT_firstfromsecondpat_crop80-ants-sim_test.csv' \
#     --earlystopping=100 \
#     --lrscheduler 20 0.5 \
#     --run_mode='eval' \
# # 712040
...
python3 ./run.py \
    ...
    --csv_file_train='./RT_allpair_crop80-ants-sim__train.csv' \
    --csv_file_val='./RT_allpair_crop80-ants-sim__val.csv' \
    --csv_file_test='./RT_guidesecond_crop80-ants-sim_test.csv' \
    --earlystopping=100 \
    --lrscheduler 20 0.5 \
    --run_mode='eval'
# 712232