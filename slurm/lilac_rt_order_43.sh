#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_43 # give your job a name
#SBATCH --nodes=1
...
#     --image_directory='/midtier/sablab/scratch/data/Prostate_RadiologyTreatment/crop_80_ProstateXdil2/crop_80' \
#     --image_size='80,80,80' \
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_40-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_best.pth' \
#     --lrscheduler 20 0.5 \
...
# all-pair
# ProstateX
# curriculum learning from 40 best
