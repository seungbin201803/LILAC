#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_50 # give your job a name
#SBATCH --nodes=1
...
#     --image_directory='/midtier/sablab/scratch/data/Prostate_RadiologyTreatment/crop_80_BladderOdil5/crop_80' \
#     --image_size='80,80,80' \
...
#     --earlystopping=100 \
#     --lrscheduler 20 0.5 \
#     --path_pretrained_model='./output/lilac_rt_order_47-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_best.pth' \
# # 765189, 821807
