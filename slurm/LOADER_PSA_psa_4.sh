#!/bin/bash
#
#SBATCH --job-name=LOADER_PSA_psa_4 # give your job a name
#SBATCH --nodes=1
...
#     --image_size='80,80,80' \
#     --csv_file_train='./RT_PSA_guidelast__train.csv' \
#     --csv_file_val='./RT_PSA_guidelast__val.csv' \
#     --csv_file_test='./RT_PSA_guidelast__test.csv' \
#     --earlystopping=100 \
#     --lrscheduler 20 0.5 \
# # 780131
