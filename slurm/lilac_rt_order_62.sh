#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_62 # give your job a name
#SBATCH --nodes=1
...
#     --image_directory='/midtier/sablab/scratch/data/Prostate_RadiologyTreatment/mask_organized_prostate/mask_organized_prostate/crop_80' \
#     --image_size='80,80,80' \
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_58-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_best.pth' \
#     --lrscheduler 20 0.5 \
