#!/bin/bash
#
#SBATCH --job-name=LOADER_FEATURES_histogram_easy_11.sh # give your job a name
#SBATCH --nodes=1
...
python3 ./run.py \
    --jobname='LOADER_FEATURES_histogram_easy_11' \
    --task_option='o' \
    ...
    --csv_file_train='./RT_histogram_bin001_easy_141_train.csv' \
    --csv_file_val='./RT_histogram_bin001_easy_141_val.csv' \
    --csv_file_test='./RT_histogram_bin001_easy_141_test.csv' \
    --earlystopping=100 \
    --mlp_input_size=141 \
    --mlp_hidden_size_list 120 100 80 60 40 20 10 5
