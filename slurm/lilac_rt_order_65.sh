#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_65 # give your job a name
#SBATCH --nodes=1
...
#     --image_directory='/midtier/sablab/scratch/data/Prostate_RadiologyTreatment/mask_organized_pb_differentval/mask_organized_pb_differentval/crop_80' \
#     --image_size='80,80,80' \
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_61-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_best.pth' \
#     --lrscheduler 20 0.5 \
# 779506
