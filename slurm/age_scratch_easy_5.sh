#!/bin/bash
#
#SBATCH --job-name=age_scratch_easy_5 # give your job a name
#SBATCH --nodes=1
...
python3 ./run.py \
    ...
    --image_size='80,80,80' \
    --csv_file_train='./RT_agenormtrain_easy_train.csv' \
    --csv_file_val='./RT_agenormtrain_easy_val.csv' \
    --csv_file_test='./RT_agenormtrain_easy_test.csv' \
    --earlystopping=100 \
    --only_pos
# 820480
