#!/bin/bash
#
#SBATCH --job-name=LOADER_FEATURES_histogram_easy_10.sh # give your job a name
#SBATCH --nodes=1
...
python3 ./run.py \
    --jobname='LOADER_FEATURES_histogram_easy_10' \
    --task_option='o' \
    ...
    --earlystopping=100 \
    --mlp_input_size=15 \
    --mlp_hidden_size_list 10 9 8 7 6 5 4 3 2
