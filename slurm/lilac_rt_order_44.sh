#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_44 # give your job a name
#SBATCH --nodes=1
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_41-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_best.pth' \
#     --lrscheduler 20 0.5 \
#763419
