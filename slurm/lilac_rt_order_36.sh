#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_36 # give your job a name
#SBATCH --nodes=1
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_32-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_epoch9.pth' \
#     --lrscheduler 20 0.5 \
#--inter_num_ch=16 \
#--num_block=6
...
# crop_segmentation
# Resnet183D
# curriculum learning from epoch10
