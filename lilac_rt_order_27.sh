#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_27 # give your job a name
#SBATCH --nodes=1
...
#     --earlystopping=100 \
#     --path_pretrained_model='./output/lilac_rt_order_26-temporal_ordering-backbone_resnet18_3D-lr0.001-seed0-batch8/model_best.pth' \
#     --lrscheduler 20 0.5 \
# #--inter_num_ch=16 \
# #--num_block=6
...
#     --lrscheduler 20 0.5 \
#     --run_mode='eval'
# 710617, 710801, 711134, 711153, 711160, 711163, 711165, 711166
...
python3 ./run.py \
    ...
    --run_mode='eval' \
    --gradcam
# 711189, 711244, 711249, 711250, 712343
