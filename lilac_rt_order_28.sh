#!/bin/bash
#
#SBATCH --job-name=lilac_rt_order_28 # give your job a name
#SBATCH --nodes=1
...
python3 ./run.py \
    ...
    --image_size='80,80,80' \
    --csv_file_train='./RT_guideone_crop80-ants-sim_train.csv' \
    --csv_file_val='./RT_guideone_crop80-ants-sim_val.csv' \
